...
echo json_encode(['userA'=>(int)$a['id'],'userB'=>(int)$b['id'],'userC'=>(int)$c['id'],'deletableUser'=>(int)$deletable['id'],'verifiableUser'=>(int)$verifiable['id'],'requestId'=>(int)$request['id'],'offerId'=>$offer,'requestDate'=>$nextFriday,'offerDate'=>$nextWednesday],JSON_UNESCAPED_UNICODE),"\n";
