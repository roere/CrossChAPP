...
final class TextTemplateCatalog
{
    ...
    public static function definitions(): array
    {
        ...
        return [
            ...
            'watchlist_representation_request' => self::mail('Neues Vertretungsgesuch in beobachtetem Chapter', 'E-Mail bei einem neuen aktiven Vertretungsgesuch in einem beobachteten Chapter.', 'Beobachtungsliste', ['chapter','requested_date','chapter_link','app_name']),
