(() => {
    ...
    const state = {
        ...
        textTemplates: [], selectedTextTemplateKey: null, textTemplateDirty: false, pendingTextTemplateKey: null, pendingInvitationOverride: null,
    };
    ...
    const elements = {
        ...
        invitationsPanel: document.querySelector('#invitations-panel'), invitationForm: document.querySelector('#invitation-form'), invitationMessage: document.querySelector('#invitation-message'), invitationList: document.querySelector('#invitation-list'), invitationResults: document.querySelector('#invitation-chapter-results'), invitationTemplateForm: document.querySelector('#invitation-template-form'), invitationTemplateMessage: document.querySelector('#invitation-template-message'), invitationVerificationDialog: document.querySelector('#invitation-verification-dialog'), invitationVerificationHeading: document.querySelector('#invitation-verification-heading'), invitationVerificationDetail: document.querySelector('#invitation-verification-detail'), confirmInvitationOverride: document.querySelector('#confirm-invitation-override'), cancelInvitationOverride: document.querySelector('#cancel-invitation-override'), cancelInvitationDialog: document.querySelector('#cancel-invitation-dialog'), confirmCancelInvitation: document.querySelector('#confirm-cancel-invitation'), cancelInvitationMessage: document.querySelector('#cancel-invitation-message'),
    };
