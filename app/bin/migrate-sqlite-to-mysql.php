...
$tables = [
    ...
    'bni_member_check_attempts', 'bni_member_directory_configs', 'bni_member_check_lock', 'bni_request_throttle',
...
try {
    ...
    $target->exec('DELETE FROM bni_request_throttle WHERE id=1 AND last_reserved_start_ms=0');
